...
import bgRegister from '@/assets/images/bg_2.jpg'
...
<template>
  <main 
    class="min-h-screen flex items-center justify-center relative bg-cover bg-center bg-no-repeat bg-fixed" :style="{ backgroundImage: `url(${bgRegister})` }" >
